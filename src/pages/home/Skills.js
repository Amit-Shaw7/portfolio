  ...
  return (
    <div id='skills' className='h-auto mt-20 flex items-center flex-col py-4'>
      ...
      <div className='h-[100%] w-[95%] flex items-center justify-center flex-wrap mt-8'>
        {
          skillArr.map((skill) => (
            <div key={skill.id} className='tooltip relative flex items-center justify-center mx-10 my-10 md:mx-16 h-[90px] w-[90px] md:h-[120px] md:w-[120px] border-[1px] border-slate-700 p-2 rounded-full'>
