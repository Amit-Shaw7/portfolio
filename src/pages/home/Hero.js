...
const Hero = () => {
    return (
        <div id='home' className='h-[90vh] hero-section overflow-y-hidden flex items-center justify-center p-1'>
            <div className='dark:text-white text-black font-bold flex items-center justify-center flex-col'>
                ...
                <a href='#hire' className='rounded-md mt-8 px-3 py-2 bg-red-500 text-black font-bold text-xl custom-transition hover-property font-mono'>Get in touch</a>
            </div>
        </div>
    )
}
